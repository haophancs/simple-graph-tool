...
void GraphMatrixTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GraphMatrixTable *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (GraphMatrixTable::*)();
        ...
        {
            using _t = void (GraphMatrixTable::*)(int , int );
...
QT_INIT_METAOBJECT const QMetaObject GraphMatrixTable::staticMetaObject = { {
    &QTableWidget::staticMetaObject,
    qt_meta_stringdata_GraphMatrixTable.data,
    qt_meta_data_GraphMatrixTable,
    qt_static_metacall,
    nullptr,
    nullptr
} };
