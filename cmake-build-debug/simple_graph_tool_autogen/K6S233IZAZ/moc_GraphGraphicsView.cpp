...
void GraphGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GraphGraphicsView *_t = static_cast<GraphGraphicsView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (GraphGraphicsView::*_t)();
        ...
        {
            typedef void (GraphGraphicsView::*_t)(int );
        ...
        {
            typedef void (GraphGraphicsView::*_t)(int , int );
        ...
        {
            typedef void (GraphGraphicsView::*_t)(QPointF );
        ...
        {
            typedef void (GraphGraphicsView::*_t)(QString , int );
...
const QMetaObject GraphGraphicsView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_GraphGraphicsView.data,
      qt_meta_data_GraphGraphicsView,  qt_static_metacall, nullptr, nullptr}
};
