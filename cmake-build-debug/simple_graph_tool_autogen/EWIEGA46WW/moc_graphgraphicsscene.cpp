...
QT_MOC_LITERAL(7, 100, 10), // "listOfPair"
QT_MOC_LITERAL(8, 111, 13), // "GraphDemoFlag"
QT_MOC_LITERAL(9, 125, 4), // "flag"
QT_MOC_LITERAL(10, 130, 14), // "std::list<int>"
QT_MOC_LITERAL(11, 145, 9), // "listOfNum"
QT_MOC_LITERAL(12, 155, 26), // "std::list<std::list<int> >"
QT_MOC_LITERAL(13, 182, 10) // "listOfList"
...
void GraphGraphicsScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->demoAlgorithm((*reinterpret_cast< std::list<int>(*)>(_a[1])),(*reinterpret_cast< GraphDemoFlag(*)>(_a[2]))); break;
        case 5: _t->demoAlgorithm((*reinterpret_cast< std::list<std::list<int> >(*)>(_a[1])),(*reinterpret_cast< GraphDemoFlag(*)>(_a[2]))); break;
        default: ;
        }
