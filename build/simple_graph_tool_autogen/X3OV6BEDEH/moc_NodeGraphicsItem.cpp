...
void NodeGraphicsItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NodeGraphicsItem *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (NodeGraphicsItem::*)();
...
QT_INIT_METAOBJECT const QMetaObject NodeGraphicsItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_NodeGraphicsItem.data,
    qt_meta_data_NodeGraphicsItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
